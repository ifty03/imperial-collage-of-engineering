                ...
                <div className="w-full md:border-l ">
                    ...
                    <div className="flex items-center justify-between px-4 lg:px-8">
                        ...
                        <div className="flex items-center justify-between space-x-2">
                            ...
                            {!user?.id && <Link to="/sign-in" className="bg-primary hover:bg-primary/80 text-white px-10 py-4 font-semibold flex items-center">
                                Log in
                                <MdArrowOutward className="ml-1 w-5 h-5" />
                            </Link>}

                            {
                                role === "admin" ? <Link to="/admin-dashboard" className="bg-primary hover:bg-primary/80 text-white px-10 py-4 font-semibold flex items-center">
                                    Dashboard
                                </Link> : (user?.id ? <button onClick={()=>{
                                        signOut()
                                        toast.success("Logged out successfully")

                                }} className="bg-red-600 hover:bg-red-500 text-white px-10 py-4 font-semibold flex items-center">
                                    Logout
                                </button> : null)
                            }
